      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-3 mb-2">
            <ClockIcon className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-[#246BFD] shrink-0" />
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">Time Table Upload</h1>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
              <div className="bg-white rounded-lg p-4 sm:p-5 md:p-6 shadow-md border-l-4 border-blue-500">
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0 pr-2">
                    ...
                    <p className="text-xl sm:text-2xl font-bold text-gray-900">{timeTables.length}</p>
                  </div>
                  <ClockIcon className="h-6 w-6 sm:h-8 sm:w-8 text-blue-500 shrink-0" />
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 sm:p-5 md:p-6 shadow-md border-l-4 border-green-500">
                <div className="flex items-center justify-between">
                  ...
                  <ClockIcon className="h-6 w-6 sm:h-8 sm:w-8 text-green-500 shrink-0" />
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 sm:p-5 md:p-6 shadow-md border-l-4 border-purple-500">
                <div className="flex items-center justify-between">
                  ...
                  <ClockIcon className="h-6 w-6 sm:h-8 sm:w-8 text-purple-500 shrink-0" />
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 sm:p-5 md:p-6 shadow-md border-l-4 border-orange-500">
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0 pr-2">
                    <p className="text-xs sm:text-sm font-medium text-gray-600 truncate">Image Files</p>
                    <p className="text-xl sm:text-2xl font-bold text-gray-900">
                      {timeTables.filter(tt => tt.type === 'image').length}
                    </p>
                  </div>
                  <ClockIcon className="h-6 w-6 sm:h-8 sm:w-8 text-orange-500 shrink-0" />
                </div>
              </div>
            </div>
          )}
