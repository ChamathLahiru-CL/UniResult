...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-white to-blue-50 border-t border-blue-100">
      <div className="max-w-7xl mx-auto px-2 py-4 sm:px-4 md:flex md:items-start md:justify-between text-sm">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 w-full">
          ...
          {/* About Us */}
          <div className="col-span-1">
            <h3 className="text-gray-800 font-medium text-sm uppercase tracking-wider mb-3">About Us</h3>
          ...
          {/* Resources */}
          <div className="col-span-1">
            <h3 className="text-gray-800 font-medium text-sm uppercase tracking-wider mb-3">Resources</h3>
            <ul className="space-y-2">
              <li>
          ...
          {/* Contact Us */}
          <div className="col-span-1">
            <h3 className="text-gray-800 font-medium text-sm uppercase tracking-wider mb-3">Contact Us</h3>
            <ul className="space-y-2">
          ...
          {/* Social Media */}
          <div className="col-span-1">
            <h3 className="text-gray-800 font-medium text-sm uppercase tracking-wider mb-3">Connect With Us</h3>
            <div className="flex space-x-3">
              <a href="https://instagram.com" className="h-8 w-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-blue-100 transition-colors duration-200" target="_blank" rel="noopener noreferrer">
                <svg className="h-4 w-4 text-gray-700 hover:text-blue-600" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://facebook.com" className="h-8 w-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-blue-100 transition-colors duration-200" target="_blank" rel="noopener noreferrer">
                <svg className="h-4 w-4 text-gray-700 hover:text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://linkedin.com" className="h-8 w-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-blue-100 transition-colors duration-200" target="_blank" rel="noopener noreferrer">
                <svg className="h-4 w-4 text-gray-700 hover:text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
              </a>
              <a href="https://twitter.com" className="h-8 w-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-blue-100 transition-colors duration-200" target="_blank" rel="noopener noreferrer">
                <svg className="h-4 w-4 text-gray-700 hover:text-blue-600" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Newsletter signup */}
            <div className="mt-4">
              <h4 className="text-xs font-medium text-gray-600 mb-2">Get Our Newsletter</h4>
              <div className="flex">
                <input 
                  type="email" 
                  placeholder="Your email" 
                  className="text-xs px-3 py-2 rounded-l-lg border border-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 w-full"
                />
                <button className="bg-blue-500 hover:bg-blue-600 text-white text-xs px-3 py-2 rounded-r-lg transition-colors duration-200">
                  Subscribe
                </button>
              </div>
            </div>
      ...
      <div className="border-t border-blue-100 mt-4">
        <div className="max-w-7xl mx-auto px-2 py-3 sm:px-4 flex flex-col md:flex-row md:items-center justify-between">
          ...
          <div className="mt-3 md:mt-0 flex space-x-6">
            <Link to="/privacy" className="text-xs text-gray-500 hover:text-blue-600 transition-colors duration-200">Privacy Policy</Link>
            <Link to="/terms" className="text-xs text-gray-500 hover:text-blue-600 transition-colors duration-200">Terms of Service</Link>
            <Link to="/cookies" className="text-xs text-gray-500 hover:text-blue-600 transition-colors duration-200">Cookie Policy</Link>
          </div>
        </div>
      </div>
    </footer>
